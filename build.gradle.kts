    ...
    extensions.configure<BaseExtension> {
        ...
        defaultConfig {
            if (isApp) {
                ...
                applicationId = customApplicationId.takeIf { it?.isNotBlank() == true } ?: "cc.flashlink.mobile"
            }
            ...
            if (!isApp) {
                ...
                setProperty("archivesBaseName", "FlashLink-Android-$versionName")
            }
        }
        ...
        signingConfigs {
            ...
            if (keystore.exists()) {
                create("release") {
                    ...
                    storeFile = rootProject.file("flashlink-release.keystore")
